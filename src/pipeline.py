...
def run_pipeline(start, config_path):
    ...
    if network_or_hdfs == "network":
        ...
        from src.utils.local_file_mods import local_file_write_feather as write_feather
        from src.utils.local_file_mods import local_file_read_feather as read_feather
        ...
        from src.utils.hdfs_mods import hdfs_file_write_feather as write_feather
        from src.utils.hdfs_mods import hdfs_file_read_feather as read_feather
    else:
    ...
    (
        ...
        cellno_df,
        postcode_itl_mapper,
    ) = run_staging(config, check_file_exists, load_json, read_csv, write_csv, read_feather, write_feather, run_id)
