...
def run_mapping(
    ...
    if not ni_full_responses.empty:
        ni_full_responses = join_itl_regions_ni(
            ni_full_responses,
            itl_mapper,
            config,
            warn_only=True,
        )
        ni_full_responses = create_additional_ni_cols(ni_full_responses)
    ...
    MappingMainLogger.success("Finished Mapping QA calculation.")
    ...
    MappingMainLogger.success("Finished Mapping NI QA calculation.")
