...
class TestCountUniquePostcodesInCol(object):
    ...
    def count_postcode_input_df(self):
        ...
        data = [
        [3990000000, 202212, "AB1 2CD", 56631, 8855030],
        [3990000000, 202212, "AB1 4FD", 56631, 8855030],
        [3990000000, 202212, np.nan, 2422, 5949501], # test nan
        [3990000006, 202212, "B23 2CD", 2437, 5949508],
    ...
    def test_count_unique_unique_postcodes_in_col(self, count_postcode_input_df):
        ...
        exp_columns = ["reference", "period", "601", "headcount_dummy", 
                       "211_dummy", "601_count"]
        exp_data = [
        [3990000000, 202212, "AB1 2CD", 56631, 8855030, 2],
        [3990000000, 202212, "AB1 4FD", 56631, 8855030, 2],
        [3990000000, 202212, np.nan, 2422, 5949501, 2], # test nan
        [3990000006, 202212, "B23 2CD", 2437, 5949508, 1],
        [3990000006, 202212, "B23 2CD", 2437, 5949508, 1], #duplicate row
