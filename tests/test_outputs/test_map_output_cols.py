...
class TestJoinPgNumeric(object):
    ...
    def main_input(self):
        ...
        data = [[0, "AA"], [1, "I"], [2, "AA"], [3, "G"], [4, "C"], [5, np.nan]]
    ...
    def test_join_pg_numeric(self, main_input, mapper_input, exp_output):
        """General tests for join_pg_numeric"""
        output = join_pg_numeric(main_input, mapper_input, ["201"])
        assert output.equals(exp_output), "Output from join_pg_numeric not as expected."
