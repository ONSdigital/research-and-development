...
class TestFormOutputPrep(object):
    ...
    def estimated_df(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'Yes', 6.0, 6, 40],
            [39900000404, 1, 202212, 'AA', 3146383.0, 4628363.0, 100.0, 'Yes', 6.0, 6, 40],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.0, 6, 40],
            ...
            [39900001029, 1, 202212, 'I', 119376.5, 244543.0, 100.0, np.nan, 1.0, 1, 14]
        ]
    ...
    def weighted_df(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 1, 202212, 'AA', 467705.0, 688000.0, 100.0, 'Yes', 6.0, 6, 40],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.0, 6, 40],
            ...
            [39900001032, 1, 202212, 'I', 119376.5, 244543.0, 100.0, np.nan, 1.0, 1, 14]
        ]
    ...
    def full_output_expected(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'Yes', 6.0, 6, 40, 2022],
            [39900000404, 1, 202212, 'AA', 3146383.0, 4628363.0, 100.0, 'Yes', 6.0, 6, 40, 2022],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.0, 6, 40, 2022],
            ...
            [39900001029, 1, 202212, 'I', 119376.5, 244543.0, 100.0, np.nan, 1.0, 1, 14, 2022]
        ]
