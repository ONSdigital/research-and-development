...
class TestFormOutputPrep(object):
    ...
    def estimated_df(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'Yes', 6.727272727272728, 6, 40],
            [39900000404, 1, 202212, 'AA', 3146383.9595, 4628363.6364, 100.0, 'Yes', 6.727272727272728, 6, 40],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.727272727272728, 6, 40],
            [39900000408, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'No', 1.0, 6, 40],
            [39900000408, 1, 202212, 'AA', 0.0, 1222.0, 100.0, 'No', 1.0, 6, 40], # 604 No and 211 > 0
            ...
            [39900001029, 1, 202212, 'I', 119376.5, 244543.1667, 100.0, np.nan, 1.0, 1, 14]
        ]
    ...
    def weighted_df(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 1, 202212, 'AA', 467705.7237114774, 688000.0, 100.0, 'Yes', 6.727272727272728, 6, 40],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.727272727272728, 6, 40],
            [39900000408, 1, 202212, 'AA', 0.0, 0.0, 100.0, 'No', 1.0, 6, 40],
            [39900000408, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'No', 1.0, 6, 40],
            [39900000576, 1, 202212, 'AA', 0.0, 0.0, 100.0, np.nan, 1.0, 1, 40],
            [39900000960, 1, 202212, 'AA', np.nan, 0.0, np.nan, 'No', 1.0, 1, 40],
            [39900001029, 1, 202212, 'I', 119376.5, 244543.16666666663, 100.0, np.nan, 1.0, 1, 14],
            [39900001031, 1, 202212, 'U', 0.0, 0.0, 100.0, 'No', 49.0, 6, 30],
            [39900001031, 2, 202212, 'U', 0.0, 0.0, 100.0, 'No', 49.0, 6, 30],
            [39900001032, 1, 202212, 'I', 119376.5, 244543.16666666663, 100.0, np.nan, 1.0, 1, 14]
        ]
    ...
    def ni_expected(self) -> pd.DataFrame:
        ...
        data = [
            [39900001577, 1, 'GB ', 0.72, 'C', 10130, 1, 'Yes', 600, 100, "0003", 3.0],
            [39900006060, 1, 'GB ', 0.6, 'G', 20120, 1, 'Yes', 600, 100, "0003", 12.0],
            [39900008752, 1, 'GB ', 0.72, 'AA', 46420, 1, 'Yes', 600, 100, "0003", 40.0],
            [39900008762, 1, 'GB ', 6.9, np.nan, 22230, 1, 'Yes', 600, 100, "0003", np.nan],
            [39900008767, 1, 'GB ', 0.72, 'D', 14190, 1, 'Yes', 600, 100, "0003", 6.0],
            [39900008807, 1, 'GB ', 0.0, 'AA', 46390, 1, 'Yes', 600, 100, "0003", 40.0],
            [39900008914, 1, 'US ', 0.0, 'E', 17219, 1, 'Yes', 600, 100, "0003", 9.0],
            [39900008968, 1, 'GB ', 1.44, 'AA', 46420, 1, 'Yes', 600, 100, "0003", 40.0],
            [39900009016, 1, 'GB ', 4.0, 'AD', 71129, 1, 'Yes', 600, 100, "0003", 50.0],
            [39900009078, 1, 'GB ', 0.72, 'J', 23610, 1, 'Yes', 600, 100, "0003", 15.0]
        ]
    ...
    def full_output_expected(self) -> pd.DataFrame:
        ...
        data = [
            [39900000404, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'Yes', 6.7272727272727275, 6, 40, 2022],
            [39900000404, 1, 202212, 'AA', 3146383.9595, 4628363.6364, 100.0, 'Yes', 6.7272727272727275, 6, 40, 2022],
            [39900000404, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'Yes', 6.7272727272727275, 6, 40, 2022],
            [39900000408, 0, 202212, 'AA', np.nan, np.nan, 100.0, 'No', 1.0, 6, 40, 2022],
            [39900000408, 2, 202212, 'AA', 0.0, 0.0, 100.0, 'No', 1.0, 6, 40, 2022],
            [39900000576, 1, 202212, 'AA', 0.0, 0.0, 100.0, np.nan, 1.0, 1, 40, 2022],
            [39900000960, 0, 202212, 'AA', np.nan, np.nan, np.nan, 'No', 1.0, 1, 40, 2022],
            [39900000960, 1, 202212, 'AA', np.nan, 0.0, np.nan, 'No', 1.0, 1, 40, 2022],
            [39900001029, 1, 202212, 'I', 119376.5, 244543.1667, 100.0, np.nan, 1.0, 1, 14, 2022]
        ]
    ...
    def tau_expected(self) -> pd.DataFrame:
        columns = [
            ...
            'form_status']
        data = [
            [39900001031, 2, 202212.0, 'U', 0.0, 0.0, 100.0, 'No', 49.0, 6, 30.0, 2022.0, np.nan, np.nan, np.nan, np.nan],
            [39900001032, 1, 202212.0, 'I', 119376.5, 244543.16666666663, 100.0, np.nan, 1.0, 1, 14.0, 2022.0, np.nan, np.nan, np.nan, np.nan],
            [39900001577, 1, np.nan, 'C', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 3.0, np.nan, 'GB ', 0.72, 10130.0, 600.0],
            [39900006060, 1, np.nan, 'G', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 12.0, np.nan, 'GB ', 0.6, 20120.0, 600.0],
            [39900008752, 1, np.nan, 'AA', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 40.0, np.nan, 'GB ', 0.72, 46420.0, 600.0],
            [39900008762, 1, np.nan, np.nan, np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", np.nan, np.nan, 'GB ', 6.9, 22230.0, 600.0],
            [39900008767, 1, np.nan, 'D', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 6.0, np.nan, 'GB ', 0.72, 14190.0, 600.0]
        ]
        full_outputs = pd.DataFrame(data=data, columns=columns)
        return full_outputs
