...
class TestFormOutputPrep(object):
    ...
    def ni_full_responses(self) -> pd.DataFrame:
        ...
        data = [
            ...
            [39900006060, 1, 2021, 'GB ', 0.6, np.nan, 20120],
    ...
    def ni_expected(self) -> pd.DataFrame:
        ...
        data = [
            [39900001577, 1, 2021, 'GB ', 0.72, 'C', 10130, 1, 'Yes', 600, 100.0, "0003", 3],
            [39900006060, 1, 2021, 'GB ', 0.6, 'G', 20120, 1, 'Yes', 600, 100.0, "0003", 12],
            [39900008752, 1, 2021, 'GB ', 0.72, 'AA', 46420, 1, 'Yes', 600, 100.0, "0003", 40],
            [39900008767, 1, 2021, 'GB ', 0.72, 'D', 14190, 1, 'Yes', 600, 100.0, "0003", 6],
            [39900008807, 1, 2021, 'GB ', 0.0, 'AA', 46390, 1, 'Yes', 600, 100.0, "0003", 40],
            [39900008914, 1, 2021, 'US ', 0.0, 'E', 17219, 1, 'Yes', 600, 100.0, "0003", 9],
            [39900008968, 1, 2021, 'GB ', 1.44, 'AA', 46420, 1, 'Yes', 600, 100.0, "0003", 40],
            [39900009016, 1, 2021, 'GB ', 4.0, 'AD', 71129, 1, 'Yes', 600, 100.0, "0003", 50],
            [39900009078, 1, 2021, 'GB ', 0.72, 'J', 23610, 1, 'Yes', 600, 100.0, "0003", 15]
        ]
    ...
    def tau_expected(self) -> pd.DataFrame:
        columns = [
            ...
            'form_status']
        data = [
            [39900001031, 2, 202212.0, 'U', 0.0, 0.0, 100.0, 'No', 49.0, 6, 30, 2022, np.nan, np.nan, np.nan, np.nan],
            [39900001032, 1, 202212.0, 'I', 119376.5, 244543.0, 100.0, np.nan, 1.0, 1, 14, 2022, np.nan, np.nan, np.nan, np.nan],
            [39900001577, 1, np.nan, 'C', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 3, 2021, 'GB ', 0.72, 10130.0, 600.0],
            [39900006060, 1, np.nan, 'G', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 12, 2021, 'GB ', 0.6, 20120.0, 600.0],
            [39900008752, 1, np.nan, 'AA', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 40, 2021, 'GB ', 0.72, 46420.0, 600.0],
            [39900008767, 1, np.nan, 'D', np.nan, np.nan, 100.0, 'Yes', 1.0, "0003", 6, 2021, 'GB ', 0.72, 14190.0, 600.0]
        ]
        full_outputs = pd.DataFrame(data=data, columns=columns)
        return full_outputs
